...
Sau bước push, remote mục tiêu là: **`htheanh2000/newtofu`** (tên repo `newtofu` trên tài khoản GitHub đang dùng; nếu tên này đã bị dùng bởi tổ chức/user khác thì tạo repo tên tương ứng và đổi remote).  
